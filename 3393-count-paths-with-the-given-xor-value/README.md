<h2><a href="https://leetcode.com/problems/count-paths-with-the-given-xor-value/?envType=problem-list-v2&envId=dynamic-programming">3659. Count Paths With the Given XOR Value</a></h2><h3>Medium</h3><hr><p>You are given a 2D integer array <code>grid</code> with size <code>m x n</code>. You are also given an integer <code>k</code>.</p>
